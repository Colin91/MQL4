...
extern double DirectionalChange4=0.050;
...
//---- drawing settings
   ...
   SetIndexStyle(4,DRAW_HISTOGRAM,0,2,Red);
   ...
   for(i=0; i<nLimit; i++)
     {
      ...
      double SellLambda = ((Open[i]-Close[i])/Open[i])*100;
      
      
       if(SellLambda < DirectionalChange1)
         {
      ...
      if(SellLambda > DirectionalChange2 && SellLambda > DirectionalChange1)
        {
         ExtVolumesBuffer[i]=500;
      ...
      if(SellLambda > DirectionalChange3 && SellLambda > DirectionalChange2 && SellLambda > DirectionalChange1)
        {
         ExtVolumesBuffer[i]=500;
         ExtDCFirstBuffer[i]=0.0;
         ExtDCSecondBuffer[i]=0.0;
      ...
      if(SellLambda > DirectionalChange4 && SellLambda > DirectionalChange3 && SellLambda > DirectionalChange2 && SellLambda > DirectionalChange1)
        {
         ExtVolumesBuffer[i]=500;
         ExtDCFirstBuffer[i]=0.0;
         ExtDCSecondBuffer[i]=0.0;
